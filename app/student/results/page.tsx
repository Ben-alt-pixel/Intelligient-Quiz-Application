...
import { resultService } from "@/lib/api-services";
      ...
      <main className="min-h-screen bg-linear-to-br from-primary/5 to-secondary/5">
        ...
        <header className="bg-primary text-primary-foreground shadow-lg">
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-6">
            <h1 className="text-3xl font-bold">{selectedResult.quiz?.title}</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 py-12">
          ...
          {/* Score Summary */}
          <Card
            className={`p-8 border-2 border-border mb-8 ${getScoreBgColor(
          ...
          <div className="space-y-4">
            {selectedResult.quiz?.questions.map((question, index) => {
              const userAnswer = question.studentAnswers[0]?.selectedAnswer;
              const isCorrect =
          ...
          <div className="mt-8 pt-8 border-t border-border/50 flex gap-3">
            <Button
              onClick={() => setSelectedResult(null)}
              variant="outline"
              className="border-2 border-primary text-primary bg-transparent"
            >
              Back to Results
            </Button>
            <Link href="/student">
